	...
	**/
	...
	function ampExtension(options)
	{
        ...
        */
		...
		var headers = ['block','trial','prime', 'prime_word', 'target', 'target_word', 'rt'];
                var myLogs = [];
                var iLog;
		...
		var layout2 = [
				...
				{location:{left:2,top:5},media:{word:leftSortingLabel}, css:{color:piCurrent.fontColor,'font-size':'2em'}},
				{location:{right:2,top:5},media:{word:rightSortingLabel},  css:{color:piCurrent.fontColor,'font-size':'2em'}}
			];
