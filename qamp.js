	...
	function ampExtension(options)
	{
        ...
        */
		...
		var layout2 = [
				...
				{location:{left:2,top:5},media:{word:leftSortingLabel}, css:{color:piCurrent.sortingLabelCSS.color,'font-size':'2em'}},
				{location:{right:2,top:5},media:{word:rightSortingLabel},  css:{color:piCurrent.sortingLabelCSS.color,'font-size':'2em'}}
			];
